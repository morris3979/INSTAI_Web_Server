...
username = 'carview'     # RDS account
password = 'Carview123'     # RDS password
host = 'rm-n9e5tl8svt18f443aro.mariadb.rds.aliyuncs.com'    # RDS address
port = '3306'         # RDS port
...
class SendFile():
	...
	def multipart_upload_boto3(self):
		...
		if resn1 == lst :    
			...
			s3 = boto3.resource('s3', aws_access_key_id=accesskey,	# S3 login setting 
    						aws_secret_access_key=secretkey, 
						endpoint_url='https://carview.oss-accelerate.aliyuncs.com')
			# close RDS connect
			session.close()
